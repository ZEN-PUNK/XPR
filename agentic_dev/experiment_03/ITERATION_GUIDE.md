...
│         ↓                                              │
│  7. Create Next Phase Prompt (if applicable)           │
│         ↓                                              │
│  8. Update Related Documentation (ubiquitous)          │
│         ↓                                              │
│  9. Improve Process Documentation (this file)          │
│                                                         │
└─────────────────────────────────────────────────────────┘
```
...
**5.4 Update MIGRATION_PLAN.md (for multi-phase work)**
```markdown
...
**Total Progress:** X/32 tools (Y%)
```

**5.5 Update EXPERIMENT_01_TOOLS_INVENTORY.md**
```markdown
# Change tool statuses:

### ✅ X.X tool_name
**Status:** ✅ Implemented (Phase X)
```

**5.6 Update DEPLOYMENT_JOURNEY.md (if debugging occurred)**
```markdown
...
### Phase 6: Create Next Phase Prompt (For Multi-Phase Migrations)

**6.1 Determine if More Phases Exist**
```bash
# Check MIGRATION_PLAN.md for remaining phases
...
**6.2 Create Next Phase Prompt (if phases remain)**

Create `COPILOT_AGENT_PROMPT_PHASE[X+1].md` with:
- Context from completed phases
- New tools to implement with enhanced descriptions
...
**Template Structure:**
```markdown
# Copilot Agent Prompt: Phase X - [Category] Tools Migration
...
## 📚 Context
### Current State
- Existing Tools: Y (from previous phases)
- Phase X-1: ✅ Complete

## 🔧 Implementation Requirements
[Detailed tool implementations with enhanced descriptions]
...
**6.3 Update COPILOT_AGENT_PROMPTS_INDEX.md**
```markdown
| Phase X | N tools | 📝 Ready | COPILOT_AGENT_PROMPT_PHASEX.md | M/32 (P%) |
```

**6.4 If All Phases Complete**
```markdown
# In MIGRATION_PLAN.md:

## 🎉 Migration Complete!
**Status:** ✅ All 32 tools implemented
...
**The Principle:** When one file changes, update ALL related files to maintain consistency.

**7.1 Documentation Dependency Map**
```
server.py changes → Triggers updates to:
├── CHANGES.md (always)
├── DEPLOYMENT_INFO.md (tool list, capabilities)
├── README.md (features, examples)
├── INDEX.md (if new docs created)
├── MIGRATION_PLAN.md (phase progress)
├── EXPERIMENT_01_TOOLS_INVENTORY.md (tool statuses)
├── COPILOT_AGENT_PROMPTS_INDEX.md (phase completion)
└── TOOL_EXPLANATIONS.md (if tools enhanced)

New phase prompt → Triggers updates to:
├── COPILOT_AGENT_PROMPTS_INDEX.md (new entry)
├── INDEX.md (new document link)
├── README.md (phase status)
└── MIGRATION_PLAN.md (next phase info)

MIGRATION_PLAN.md → Triggers updates to:
├── README.md (progress percentage)
├── COPILOT_AGENT_PROMPTS_INDEX.md (sync status)
└── agent.md (if architecture implications)
```

**7.2 Synchronization Checklist**
...
- [ ] CHANGES.md - New change entry added
- [ ] README.md - Features/status updated  
- [ ] INDEX.md - New docs linked (if applicable)

### Phase-Specific Files
- [ ] MIGRATION_PLAN.md - Phase progress updated
- [ ] EXPERIMENT_01_TOOLS_INVENTORY.md - Tool statuses updated
- [ ] COPILOT_AGENT_PROMPTS_INDEX.md - Phase tracking updated

### Context Files (Update if Changed)
- [ ] agent.md - Architecture changes noted
- [ ] DEPLOYMENT_INFO.md - New capabilities listed
- [ ] TOOL_EXPLANATIONS.md - New tool docs added

### Meta Files  
- [ ] ITERATION_GUIDE.md - Process improvements added
```

**7.3 Progress Metrics Synchronization**

Ensure consistency across:
```
README.md: "Progress: X/32 tools (Y%)"
MIGRATION_PLAN.md: "Total Progress: X/32 tools (Y%)"
COPILOT_AGENT_PROMPTS_INDEX.md: "Completed: X/32 (Y%)"
EXPERIMENT_01_TOOLS_INVENTORY.md: ✅/❌ status emojis
```

**7.4 Cross-Reference Validation**
```bash
# Check all markdown links work
grep -r "\[.*\](.*.md)" *.md

# Verify version numbers consistent  
grep -r "Version:" *.md | sort | uniq

# Check timestamps synchronized
grep -r "Last Updated:" *.md | sort
```

---

### Phase 8: Process Improvement (Meta-Documentation)

**8.1 Update ITERATION_GUIDE.md (this file)**
