# Experiment 04: XPR Blockchain MCP Server on Azure Functions

**Production-Ready Proton Blockchain MCP Server with RPC Failover**

[![Status](https://img.shields.io/badge/status-production-green)]()
[![Progress](https://img.shields.io/badge/progress-81.3%25-blue)]()
[![Azure](https://img.shields.io/badge/azure-functions-blue)]()
[![Python](https://img.shields.io/badge/python-3.12-blue)]()
[![MCP](https://img.shields.io/badge/MCP-FastMCP-purple)]()

> 🎯 **Current Status:** 81.3% Complete (26/32 tools) - Phase 4B-Partial deployed
> 
> 📖 **Start Here:** [CURRENT_STATUS.md](./CURRENT_STATUS.md) - Main entry point with complete navigation
...
**Tools Available:** 27 (25 blockchain + 2 legacy)
...
**For Development:**
3. **[ITERATION_GUIDE.md](./ITERATION_GUIDE.md)** - 9-phase iterative development cycle (ESSENTIAL!)
4. **[CHANGES.md](./CHANGES.md)** - Complete change history (update before/after changes)
5. **[MIGRATION_PLAN.md](./MIGRATION_PLAN.md)** - 32-tool migration strategy (4 phases)
6. **[COPILOT_AGENT_PROMPTS_INDEX.md](./COPILOT_AGENT_PROMPTS_INDEX.md)** - Phase-by-phase execution guides
7. **[AGENT_PROMPT.md](./AGENT_PROMPT.md)** - Original implementation guide
...
**Progress:** 14/32 tools (43.8%) - See [PROGRESS_METRICS.md](./PROGRESS_METRICS.md)
...
### Phase 3: DeFi Tools ✅
9. **get_lending_markets** - MetalX lending markets with APY
10. **get_oracle_prices** - Real-time price oracle
11. **get_lending_position** - User lending positions & health
...
- get_transaction
- get_actions
- ... and 14 more (see [MIGRATION_PLAN.md](./MIGRATION_PLAN.md))

### Legacy Tools
14. **get_account** - Comprehensive account information  
15. **get_user_info** - Azure AD token exchange demo

**See:** [TOOL_EXPLANATIONS.md](./TOOL_EXPLANATIONS.md) for detailed Phase 1 tool documentation

---

## 📖 Example Usage

### 1. get_account (Legacy)
...
**Portal Link:**
```
https://portal.azure.com/#@/resource/subscriptions/AZURE-SUBSCRIPTION-ID/resourceGroups/AZURE-RESOURCE-GROUP/overview
```
